...
async def main():
    ...
    dp_instance.message.register(handlers.command_ai_advice_handler, Command("ai_advice"))
    dp_instance.message.register(handlers.help_handler, Command("help"))


    dp_instance.message.register(handlers.process_mood, StateFilter(handlers.Tracking.waiting_for_mood),F.text.regexp(r'^(10|[1-9])$'))
